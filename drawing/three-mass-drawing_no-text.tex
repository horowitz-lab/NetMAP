...
\usepackage[paperwidth=10cm, paperheight=5cm, margin=0in]{geometry}
\usepackage{tikz}
...
\newcommand{\massheight}{0.8cm}
\newcommand{\wallthickness}{0.25cm}
\newcommand{\figwidth}{4.4cm}
...
\newcommand{\wallheight}{3.5cm}
\newcommand{\dottedboxheight}{2.9 cm}
...
\node(dottedbox) [minimum width=\masstwopos-\leftwalleastpos+\masswidth*1.1, 
			   minimum height=\dottedboxheight, 
			   xshift=\massonepos+\masswidth/3, 
			   yshift=\labelheight+.19cm,
