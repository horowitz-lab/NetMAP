...
\usepackage[paperwidth=7.5in, paperheight=3cm, margin=0in]{geometry}
\usepackage{tikz}
...
\newcommand{\figwidth}{4*4.1cm}
\newcommand{\springlength}{\figwidth/6-5*\masswidth/6}
\newcommand\wallspringlength{1.6cm}
...
\node (wallone)  [wall, xshift=\wallonepos, yshift=\levelone,anchor=east] {};
\draw (wallone.north east) -- (wallone.south east);
